  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <h2 className="text-2xl font-semibold text-white mb-3">3D 스크롤 공간</h2>
        ...
        >
          <h2 className="text-2xl font-semibold text-white mb-3">메타볼 효과</h2>
          <p className="text-cyan-100 mb-4">
            WebGL 셰이더를 사용한 2D 메타볼 효과 - 원들이 부드럽게 연결되는 인터랙티브 데모
          </p>
        ...
        >
          <h2 className="text-2xl font-semibold text-white mb-3">캔버스 효과</h2>
        ...
        >
          <h2 className="text-2xl font-semibold text-white mb-3">프로젝트 정보</h2>
